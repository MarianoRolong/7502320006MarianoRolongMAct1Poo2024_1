...
public class VentanaReporteUsuarios extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REPORTES USUARIOS");

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/marianorolong/Ventanas/iconos/reportesUsuariosImagen.png"))); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        Collection<Persona> datos = Persona.usuariosBD.values();
        
        List<Persona> listaUsuarios = new ArrayList(datos);
        
        String columnas [] = {"NOMBRE", "APELLIDO", "TELEFONO", "DIRECCION", "IDENTIFICACION"};
        int totalUsuarios = listaUsuarios.size();
        String filas [][] = new String [totalUsuarios][columnas.length];
        for(int i = 0; i < listaUsuarios.size(); i++){
        Persona u = listaUsuarios.get(i);
        filas[i][0] = u.nombre;
        filas[i][1] = u.apellido;
        filas[i][2] = u.numeroTelefono;
        filas[i][3] = u.direccion;
        filas[i][4] = u.identificacion;
        }
